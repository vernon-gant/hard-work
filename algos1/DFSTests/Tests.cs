...
namespace DFSTests
{
    ...
    public class TenVerticesGraph
    {
        ...
        public void ExistingPathFirst()
        {
            ...
            List<Vertex<int>> path = graph.DepthFirstSearch(0, 12);

            Assert.AreEqual(8, path.Count);
            Assert.AreEqual(1, path[0].Value);
            Assert.AreEqual(2, path[1].Value);
            Assert.AreEqual(3, path[2].Value);
            Assert.AreEqual(5, path[3].Value);
            Assert.AreEqual(7, path[4].Value);
            Assert.AreEqual(8, path[5].Value);
            Assert.AreEqual(9, path[6].Value);
            Assert.AreEqual(13, path[7].Value);
        }
        ...
        public void ExistingPathSecond()
        {
            ...
            List<Vertex<int>> path = graph.DepthFirstSearch(10, 4);
        ...
        public void NonExistingPath()
        {
            ...
            List<Vertex<int>> path = graph.DepthFirstSearch(0, 13);
        ...
        public void ExistingCyclicPath()
        {
            ...
            List<Vertex<int>> path = graph.DepthFirstSearch(0, 0);
        ...
        public void NonExistingCyclicPath()
        {
            ...
            List<Vertex<int>> path = graph.DepthFirstSearch(2, 2);
